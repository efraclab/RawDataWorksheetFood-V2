...
import {
  ...
  type SmapleDetailsRequest,
} from "../../core/worksheet/worksheetCreationService";
...
const CreateWorksheet: React.FC<CreateWorksheetProps> = ({
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const data = await worksheetCreationService.fetchSample(request);
  ...
  const handleCreateWorksheet = async () => {
    ...
    try {
      ...
      const response = await worksheetCreationService.createWorksheet(worksheetData);

      if (response && response.worksheetId) {

        worksheetCreationService.insertWorksheetLog({
