...
const Login = () => {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      /*
       * Preserve V1 success behavior.
       */
      setSuccess(true);

      /*
       * Preserve V1 900ms redirect delay.
       */
      setTimeout(() => {
        navigate("/dashboard", {
          replace: true,
      ...
      /*
       * Preserve V1 invalid-credential
       * message behavior.
       */
      if (
    ...
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden">
      <style>{`
        ...
        .nav-gradient {
          ...
          animation:
            gradientFlow 14s ease infinite;
        }
        ...
        .morph-blob {
          animation:
            morphBlob 9s ease-in-out infinite,
            floatSlow 8s ease-in-out infinite;
        }

        .morph-blob2 {
          animation:
            morphBlob 11s ease-in-out infinite reverse,
            floatSlow 10s ease-in-out infinite reverse;
        }

        .morph-blob3 {
          animation:
            morphBlob 13s ease-in-out infinite 2s,
      ...
      <div className="lg:w-[52%] relative nav-gradient flex flex-col overflow-hidden min-h-[260px] lg:min-h-screen">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full px-10 py-12 max-w-[520px] mx-auto w-full">
          <div>
            ...
            >
              Streamline your laboratory data management with precision and full
              audit traceability.
            </p>
            ...
            >
              {[
                ...
                <div
                  ...
                  "
                  style={{
                    animationDelay: `${0.24 + index * 0.06}s`,
                  }}
                >
                  <p
                    className="
              ...
              {[
                {
                  ...
                  desc: "Track and organise laboratory raw data",
                ...
                },
                {
                  ...
                  desc: "Build and reuse worksheet prep templates",
                ...
                },
                {
                  icon: BarChart3,
                  title: "Data Analysis",
                  desc: "Comprehensive analysis and validation tools",
                ...
                },
                {
                  ...
                  desc: "Generate detailed reports and documentation",
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(rgba(5,150,105,0.8) 1px,transparent 1px)",
