...
import { nh3AmbientPreparationDefinition } from "./definition";

const ok = async (context: PreparationContext): Promise<PreparationResult> => ({
  success: true, data: context.data, errors: [], warnings: [],
});

export const nh3AmbientPreparationHandler: PreparationHandler = {
  definition: nh3AmbientPreparationDefinition,
