...
import CalculationDetailChlorineAmbient from "./CalculationDetailChlorineAmbient";
...
export default function ChlorineAmbientCalculationSection({
  calculations,
  samplePreparations,
  onAdd,
  onRemove,
        ...
        {calculations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-emerald-300 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-12 text-center shadow-inner">
            ...
            <p className="mb-1 mt-3 text-base font-semibold text-emerald-800">
              No ChlorineAmbient calculations added yet
            </p>
          ...
          <div className="space-y-6">
            {calculations.map((calculation) => (
              <CalculationDetailChlorineAmbient
                key={calculation.id}
