...
import { h2sStackPreparationDefinition } from "./definition";

const ok = async (context: PreparationContext): Promise<PreparationResult> => ({
  success: true, data: context.data, errors: [], warnings: [],
});

export const h2sStackPreparationHandler: PreparationHandler = {
  definition: h2sStackPreparationDefinition,
