...
import { soilOrganicCarbonMatterPreparationDefinition } from "./definition";
...
export const soilOrganicCarbonMatterPreparationHandler: PreparationHandler = {
  definition: soilOrganicCarbonMatterPreparationDefinition,
  capabilities: {
    collectData: ok,
    validate: ok,
    calculate: ok,
