...
import { matterSolubleInWaterPreparationDefinition } from "./definition";

const ok = async (context: PreparationContext): Promise<PreparationResult> => ({
  success: true, data: context.data, errors: [], warnings: [],
});

export const matterSolubleInWaterPreparationHandler: PreparationHandler = {
  definition: matterSolubleInWaterPreparationDefinition,
