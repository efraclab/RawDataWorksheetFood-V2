...
import { sulphatePreparationDefinition } from "./definition";

export const sulphatePreparationHandler: PreparationHandler = {
  definition: sulphatePreparationDefinition,
  capabilities: {
