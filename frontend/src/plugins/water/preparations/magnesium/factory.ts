...
import type {
  SamplePreparationMagnesium,
  SamplePreparationMagnesiumStep,
} from "./models/SamplePreparationMagnesium";
...
export const createSamplePreparationMagnesium = (
  index: number,
): SamplePreparationMagnesium => ({
  id: createId(index),
...
export const createCalculationMagnesium = (
  index: number,
): CalculationMagnesium => ({
  id: createId(index),
...
export const restoreCalculationMagnesium = (
  value: unknown,
): CalculationMagnesium => {
  const source =
  ...
  const data =
    source && typeof source === "object"
      ? (source as Partial<CalculationMagnesium>)
      : {};
  ...
  return {
    ...
    calculationResultTertiary:
      typeof data.calculationResultTertiary === "number" ? data.calculationResultTertiary : null,
    acceptanceLimitMin:
