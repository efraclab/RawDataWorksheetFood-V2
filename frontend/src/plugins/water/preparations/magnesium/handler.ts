...
import { magnesiumPreparationDefinition } from "./definition";

export const magnesiumPreparationHandler: PreparationHandler = {
  definition: magnesiumPreparationDefinition,
  capabilities: {
