...
import { sulphidePreparationDefinition } from "./definition";

export const sulphidePreparationHandler: PreparationHandler = {
  definition: sulphidePreparationDefinition,
  capabilities: {
