...
import CalculationDetailTotalPhosphorus from "./CalculationDetailTotalPhosphorus";
...
interface Props {
  ...
  onUpdate: (calculation: CalculationTotalPhosphorus) => void;
}

export default function TotalPhosphorusCalculationSection({
  calculations,
  samplePreparations,
  onAdd,
  onRemove,
        ...
        {calculations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-emerald-300 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-12 text-center shadow-inner">
            ...
            <p className="mb-1 mt-3 text-base font-semibold text-emerald-800">
              No Total Phosphorus calculations added yet
            </p>
          ...
          <div className="space-y-6">
            {calculations.map((calculation) => (
              <CalculationDetailTotalPhosphorus
                key={calculation.id}
