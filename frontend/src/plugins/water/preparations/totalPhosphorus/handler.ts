...
import { totalPhosphorusPreparationDefinition } from "./definition";

export const totalPhosphorusPreparationHandler: PreparationHandler = {
  definition: totalPhosphorusPreparationDefinition,
  capabilities: {
