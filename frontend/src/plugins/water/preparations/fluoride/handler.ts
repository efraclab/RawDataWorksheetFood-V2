...
import { fluoridePreparationDefinition } from "./definition";

export const fluoridePreparationHandler: PreparationHandler = {
  definition: fluoridePreparationDefinition,
  capabilities: {
