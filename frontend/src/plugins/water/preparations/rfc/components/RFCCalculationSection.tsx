...
import CalculationDetailRFC from "./CalculationDetailRFC";
...
export default function RFCCalculationSection({
  calculations,
  samplePreparations,
  canEditCalculations,
  onAdd,
      ...
      <div className="mx-6 rounded-2xl border border-emerald-200 bg-white/70 p-6 shadow-lg">
        <div className="mb-6 flex items-center justify-between">
          <h3 className="flex items-center gap-3 text-lg font-bold text-emerald-900">
            ...
            Residual Free Chlorine (as Cl2) Calculation
          </h3>
