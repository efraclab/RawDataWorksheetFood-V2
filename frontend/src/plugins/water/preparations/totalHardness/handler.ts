...
import { totalHardnessPreparationDefinition } from "./definition";

export const totalHardnessPreparationHandler: PreparationHandler = {
  definition: totalHardnessPreparationDefinition,
  capabilities: {
