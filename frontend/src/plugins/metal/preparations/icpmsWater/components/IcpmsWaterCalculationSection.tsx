...
import CalculationDetailIcpmsWater from "./CalculationDetailIcpmsWater";

interface Props {
  calculations: CalculationIcpmsWater[];
 ...
 * rendered here.
 */
const IcpmsWaterCalculationSection: React.FC<Props> = ({
  calculations,
  samplePreparations,
  canEditCalculations,
  onAdd,
        ...
        {calculations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-emerald-300 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-12 text-center shadow-inner">
            ...
            <p className="mb-1 mt-3 text-base font-semibold text-emerald-800">
              No ICP-MS (Water) calculations added yet
            </p>
...
export default IcpmsWaterCalculationSection;
