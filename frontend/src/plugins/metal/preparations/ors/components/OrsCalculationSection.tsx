...
import CalculationDetailOrs from "./CalculationDetailOrs";

interface Props {
  calculations: CalculationOrs[];
...
/**
 * ORS calculation section intentionally mirrors the LOD calculation
 * section. The old Excel-style calculation table/formula header is not
 * rendered here.
 */
const OrsCalculationSection: React.FC<Props> = ({
  calculations,
  samplePreparations,
  canEditCalculations,
  onAdd,
...
export default OrsCalculationSection;
