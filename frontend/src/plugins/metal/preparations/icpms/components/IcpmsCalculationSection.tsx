...
import CalculationDetailIcpms from "./CalculationDetailIcpms";

interface Props {
  calculations: CalculationIcpms[];
...
/** Shared-engine-compatible calculation section for the Metal ICP-MS module. */
const IcpmsCalculationSection: React.FC<Props> = ({
  calculations,
  samplePreparations,
  canEditCalculations,
  onAdd,
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-emerald-600">
              Calculation editing is controlled independently from preparation locking.
            </p>
          </div>
          <button
            type="button"
...
export default IcpmsCalculationSection;
