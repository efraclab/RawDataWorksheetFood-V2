...
import { fattyacidprofilePreparationDefinition } from "./definition";

export const fattyacidprofilePreparationHandler: PreparationHandler = {
  definition: fattyacidprofilePreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Fatty Acid Profile Sample Preparation is required."];
