...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationFattyAcidProfile,
        value: any
    ) => void;
...
const CalculationDetailFattyAcidProfile:
    React.FC<Props> = ({
        ...
        // ========================================================
        // FATTY ACID PROFILE CALCULATION
        // ========================================================

        /*
            Fatty Acid Profile:

            (Sample Area % × Fat Content)
            ----------------------------
                        100
        ...
        */
        ...
        const calculatedFattyAcidProfile =
            useMemo(() => {
        ...
        const validationErrors =
            useMemo(() => {
                ...
                if (sampleAreaPercent < 0) {

                    errors.push(
                        "Sample Area % cannot be negative"
                    );

                }


                if (sampleAreaPercent > 100) {

                    errors.push(
                        "Sample Area % cannot be greater than 100"
                    );
        ...
        const handleCalculate =
            () => {
                ...
                const result =
                    Number(
                        calculatedFattyAcidProfile.toFixed(3)
                    );
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    Calculation for Fatty Acid Profile
...

                                {
                                    selectedPreparation && (
                                        ...
                                        >
                                            ...
                                            "
                                            >
                                                Formula for Fatty Acid Profile
                                            </h4>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    (
                                                    {sampleAreaPercent.toFixed(4)}
                                                    {" × "}
                                                    {fatContent.toFixed(4)}
                                                    )
                                                    {" ÷ 100"}
...
export default CalculationDetailFattyAcidProfile;