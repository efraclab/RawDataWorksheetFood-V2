...
} from "../models/CalculationCholesterol";

import type {
    SamplePreparationCholesterol
} from "../models/SamplePreparationCholesterol";
...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationCholesterol,
        value: any
    ) => void;
...
const CalculationDetailCholesterol:
    React.FC<Props> = ({
        ...
        /*
            ...
            (Instrument Conc × Volume × Dilution Factor × Purity)
            ----------------------------------------------------
                (Sample wt × 10 × 100)
        ...
        */
        ...
        const validationErrors =
            useMemo(() => {
                ...
                if (sampleWeight <= 0) {
                    ...
                    errors.push(
                        "Sample wt must be greater than 0"
                    );
                ...
                if (instrumentConcentration < 0) {
                    ...
                    errors.push(
                        "Instrument Conc cannot be negative"
                    );
        ...
        const handleCalculate =
            () => {
                ...
                const result =
                    Number(
                        calculatedCholesterol.toFixed(2)
                    );
...
export default CalculationDetailCholesterol;