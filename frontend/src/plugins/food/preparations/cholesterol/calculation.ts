/**
 * V2 runtime result adapter for the V1 Cholesterol calculation.
 ...
 */
export interface CholesterolCalculationResult {
...
export function calculateCholesterol(data: any): CholesterolCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Cholesterol calculation result is not available." }),
  };
}
