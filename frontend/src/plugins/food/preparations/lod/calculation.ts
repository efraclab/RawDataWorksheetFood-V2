...
/**
 * Matches the V1 Number.prototype.toFixedNoRound behavior.
 *
 * V1 first truncates the number to 4 decimal places,
 * then calls normal toFixed(3).
 */
...
export function calculateLod(
    ...
    return {
        ...
        result: truncatedToFourDecimals.toFixed(3),
