...
import { artificialsweetnerPreparationDefinition } from "./definition";

export const artificialsweetnerPreparationHandler: PreparationHandler = {
  definition: artificialsweetnerPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Artificial Sweetener Sample Preparation is required."];
