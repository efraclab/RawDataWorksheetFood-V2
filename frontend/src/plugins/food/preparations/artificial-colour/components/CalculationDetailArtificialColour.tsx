...
} from "../models/CalculationArtificialColour";

import type {
    SamplePreparationArtificialColour
} from "../models/SamplePreparationArtificialColour";
...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationArtificialColour,
        value: any
    ) => void;
...
const CalculationDetailArtificialColour:
    React.FC<Props> = ({
        ...
        // ========================================================
        // ARTIFICIAL SWEETNER CALCULATION
        // ========================================================

        /*
            Artificial Colour (mg/kg):

            Instrument Concentration × Volume × Dilution Factor
            × Purity / 100
            -----------------------------------------------
                         Sample Weight
        ...
        */
        ...
        const calculatedArtificialSweetner =
            useMemo(() => {
        ...
        const handleCalculate =
            () => {
                ...
                const result =
                    Number(
                        calculatedArtificialSweetner.toFixed(2)
                    );
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    Calculation for Artificial Colour
                    ...
                    {isExpanded && (
                        ...
                        >
                            ...
                            ================================================= */}
                                ...
                                {/* =================================================
                                ARTIFICIAL COLOUR INPUT VALUES
                            ================================================= */}
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    (
                                                    {instrumentConcentration.toFixed(4)}
                                                    {" × "}
                                                    {volume.toFixed(4)}
                                                    {" × "}
...
export default CalculationDetailArtificialColour;