...
import { artificialcolourPreparationDefinition } from "./definition";

export const artificialcolourPreparationHandler: PreparationHandler = {
  definition: artificialcolourPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Artificial Colour Sample Preparation is required."];
