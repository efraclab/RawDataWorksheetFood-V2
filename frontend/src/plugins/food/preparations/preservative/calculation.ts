/**
 * V2 runtime result adapter for the V1 Preservative calculation.
 ...
 */
export interface PreservativeCalculationResult {
...
export function calculatePreservative(data: any): PreservativeCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Preservative calculation result is not available." }),
  };
}
