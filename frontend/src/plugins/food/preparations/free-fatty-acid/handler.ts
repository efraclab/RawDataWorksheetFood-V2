...
import { freefattyacidPreparationDefinition } from "./definition";

export const freefattyacidPreparationHandler: PreparationHandler = {
  definition: freefattyacidPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Free Fatty Acid Sample Preparation is required."];
