...
import { energyPreparationDefinition } from "./definition";

export const energyPreparationHandler: PreparationHandler = {
  definition: energyPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Energy Sample Preparation is required."];
