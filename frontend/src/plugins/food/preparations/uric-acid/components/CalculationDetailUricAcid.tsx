...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationUricAcid,
        value: any
    ) => void;
...
const CalculationDetailUricAcid:
    React.FC<Props> = ({
...
export default CalculationDetailUricAcid;