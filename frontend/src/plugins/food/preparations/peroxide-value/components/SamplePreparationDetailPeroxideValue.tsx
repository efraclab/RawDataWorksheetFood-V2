...
const SamplePreparationDetailPeroxideValue:
    React.FC<Props> = ({
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    <CustomDropdown
                                                                        ...
                                                                        value={
                                                                            step.unit1 ||
                                                                            (step.name.trim().toLowerCase() === "normality"
                                                                                ? "ml"
                                                                                : "")
                                                                        }
...
export default SamplePreparationDetailPeroxideValue;