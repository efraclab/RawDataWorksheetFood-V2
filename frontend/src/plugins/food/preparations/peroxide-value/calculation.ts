/**
 * V2 runtime result adapter for the V1 Peroxide Value calculation.
 ...
 */
export interface PeroxideValueCalculationResult {
...
export function calculatePeroxideValue(data: any): PeroxideValueCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Peroxide Value calculation result is not available." }),
  };
}
