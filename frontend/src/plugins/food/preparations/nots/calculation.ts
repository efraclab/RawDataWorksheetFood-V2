/**
 * V2 runtime result adapter for the V1 NOTS calculation.
 ...
 */
export interface NotsCalculationResult {
...
export function calculateNots(data: any): NotsCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "NOTS calculation result is not available." }),
  };
}
