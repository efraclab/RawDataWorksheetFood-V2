...
import { notsPreparationDefinition } from "./definition";

export const notsPreparationHandler: PreparationHandler = {
  definition: notsPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["NOTS Sample Preparation is required."];
