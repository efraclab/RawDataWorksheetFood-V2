...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationSulphurDioxide,
        value: any
    ) => void;
...
const CalculationDetailSulphurDioxide:
    React.FC<Props> = ({
        ...
        // ========================================================
        // SULPHUR DIOXIDE CALCULATION
        // ========================================================

        /*
            Sulphur Dioxide (mg/kg):

            ((Sample Titre Value - Blank Titre Value)
             × Normality × 32.03 × 1000)
            --------------------------------
                    Sample Weight
        */

        const calculatedSulphurDioxide =
            useMemo(() => {
        ...
        const handleCalculate =
            () => {
                ...
                const result =
                    Number(
                        calculatedSulphurDioxide.toFixed(2)
                    );
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    Calculation for Sulphur Dioxide
...
export default CalculationDetailSulphurDioxide;