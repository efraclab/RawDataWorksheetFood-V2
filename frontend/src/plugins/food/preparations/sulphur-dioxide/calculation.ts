/**
 * V2 runtime result adapter for the V1 Sulphur Dioxide calculation.
 ...
 */
export interface SulphurDioxideCalculationResult {
...
export function calculateSulphurDioxide(data: any): SulphurDioxideCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Sulphur Dioxide calculation result is not available." }),
  };
}
