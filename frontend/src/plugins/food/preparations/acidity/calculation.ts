/**
 * V2 runtime result adapter for the V1 Acidity calculation.
 ...
 */
export interface AcidityCalculationResult {
...
export function calculateAcidity(data: any): AcidityCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Acidity calculation result is not available." }),
  };
}
