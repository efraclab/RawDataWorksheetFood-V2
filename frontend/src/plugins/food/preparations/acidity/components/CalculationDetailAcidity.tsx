...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationAcidity,
        value: any
    ) => void;
...
const CalculationDetailAcidity:
    React.FC<Props> = ({
...
export default CalculationDetailAcidity;