/**
 * V2 runtime result adapter for the V1 WSV (Water Soluble Vitamins) calculation.
 ...
 */
export interface WsvCalculationResult {
...
export function calculateWsv(data: any): WsvCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "WSV (Water Soluble Vitamins) calculation result is not available." }),
  };
}
