/**
 * V2 runtime result adapter for the V1 Moisture calculation.
 ...
 */
export interface MoistureCalculationResult {
...
export function calculateMoisture(data: any): MoistureCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Moisture calculation result is not available." }),
  };
}
