...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationMoisture,
        value: any
    ) => void;
...
const CalculationDetailMoisture:
    React.FC<Props> = ({
        ...
        const samplePlusDishAfterDryingWeight =
            toNumber(
                getStep(
        ...
        */
        ...
        const validationErrors =
            useMemo(() => {
                ...
                if (emptyDishWeight <= 0) {

                    errors.push(
                        "Weight of Empty Dish (W1) must be greater than 0"
                    );

                }

                if (samplePlusDishWeight <= 0) {

                    errors.push(
                        "Weight of Sample + Dish (W2) must be greater than 0"
                    );
                ...
                if (
                    ...
                    errors.push(
                        "W2 must be greater than W1"
                    );

                }

                if (
                    samplePlusDishAfterDryingWeight <= 0
                ) {

                    errors.push(
                        "Weight of Sample + Dish after Drying (W3) must be greater than 0"
                    );
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    (
                                                    {samplePlusDishWeight.toFixed(4)}
                                                    {" - "}
                                                    {samplePlusDishAfterDryingWeight.toFixed(4)}
                                                    {" ) ÷ ( "}
                                                    {samplePlusDishWeight.toFixed(4)}
                                                    {" - "}
                                                    {emptyDishWeight.toFixed(4)}
                                                    {" ) × 100"}
...
export default CalculationDetailMoisture;