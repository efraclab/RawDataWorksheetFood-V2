...
import { saponificationvaluePreparationDefinition } from "./definition";

export const saponificationvaluePreparationHandler: PreparationHandler = {
  definition: saponificationvaluePreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Saponification Value Sample Preparation is required."];
