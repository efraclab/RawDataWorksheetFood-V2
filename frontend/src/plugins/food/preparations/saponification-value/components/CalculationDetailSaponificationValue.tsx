...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationSaponificationValue,
        value: any
    ) => void;
...
const CalculationDetailSaponificationValue:
    React.FC<Props> = ({
        ...
        */
        ...
        const calculatedSaponificationValue =
            useMemo(() => {
        ...
        const validationErrors =
            useMemo(() => {
                ...
                if (
                    ...
                    errors.push(
                        "Blank Titre Value cannot be negative"
                    );
                ...
                // ------------------------------------------------
                // BLANK MUST BE GREATER THAN SAMPLE
                // ------------------------------------------------
                ...
                if (
                    ...
                    errors.push(
                        "Blank Titre Value should be greater than or equal to Sample Titre Value"
                    );
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {
                                                        calculatedSaponificationValue.toFixed(
                                                            2
                                                        )
                                                    }
...
export default CalculationDetailSaponificationValue;