...
import { sugarsaponincatechinprofilePreparationDefinition } from "./definition";

export const sugarsaponincatechinprofilePreparationHandler: PreparationHandler = {
  definition: sugarsaponincatechinprofilePreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Sugar / Saponin / Catechin Profile Sample Preparation is required."];
