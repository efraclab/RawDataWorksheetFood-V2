/**
 * V2 runtime result adapter for the V1 Sugar / Saponin / Catechin Profile calculation.
 ...
 */
export interface SugarSaponinCatechinProfileCalculationResult {
...
export function calculateSugarSaponinCatechinProfile(data: any): SugarSaponinCatechinProfileCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Sugar / Saponin / Catechin Profile calculation result is not available." }),
  };
}
