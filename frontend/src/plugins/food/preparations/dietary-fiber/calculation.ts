/**
 * V2 runtime result adapter for the V1 Dietary Fiber calculation.
 ...
 */
export interface DietaryFiberCalculationResult {
...
export function calculateDietaryFiber(data: any): DietaryFiberCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Dietary Fiber calculation result is not available." }),
  };
}
