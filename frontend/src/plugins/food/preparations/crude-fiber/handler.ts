...
import { crudefiberPreparationDefinition } from "./definition";

export const crudefiberPreparationHandler: PreparationHandler = {
  definition: crudefiberPreparationDefinition,
  capabilities: {
    ...
    validate: async (context: PreparationContext): Promise<PreparationResult> => {
      ...
      const errors = hasPreparation ? [] : ["Crude Fiber Sample Preparation is required."];
