/**
 * V2 runtime result adapter for the V1 Crude Fiber calculation.
 ...
 */
export interface CrudeFiberCalculationResult {
...
export function calculateCrudeFiber(data: any): CrudeFiberCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Crude Fiber calculation result is not available." }),
  };
}
