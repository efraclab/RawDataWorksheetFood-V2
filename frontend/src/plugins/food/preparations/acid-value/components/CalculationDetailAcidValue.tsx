...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationAcidValue,
        value: any
    ) => void;
...
const CalculationDetailAcidValue:
    React.FC<Props> = ({
...
export default CalculationDetailAcidValue;