...
const CalculationDetailFAT: React.FC<CalculationDetailFATProps> = ({
    calculation,
    samplePreparations,
    onFieldChange,
    onRemove,
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="text-center border-b-2 border-black pb-2 mb-2 px-2 w-full">
                            <p className="text-xs font-mono text-black break-words">
                                (Final Weight of R.B Flask after Drying in g W2)
                                -
                                (Initial Empty Weight of R.B Flask in g W1)
                            </p>
                        </div>
...
export default CalculationDetailFAT;