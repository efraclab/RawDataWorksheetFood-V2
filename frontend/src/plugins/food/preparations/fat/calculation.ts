/**
 * V2 runtime result adapter for the V1 FAT calculation.
 ...
 */
export interface FatCalculationResult {
...
export function calculateFat(data: any): FatCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "FAT calculation result is not available." }),
  };
}
