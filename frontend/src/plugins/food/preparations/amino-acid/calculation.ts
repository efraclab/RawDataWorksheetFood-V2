/**
 * V2 runtime result adapter for the V1 Amino Acid calculation.
 ...
 */
export interface AminoAcidCalculationResult {
...
export function calculateAminoAcid(data: any): AminoAcidCalculationResult {
  ...
  return {
    ...
    ...(valid ? {} : { error: "Amino Acid calculation result is not available." }),
  };
}
