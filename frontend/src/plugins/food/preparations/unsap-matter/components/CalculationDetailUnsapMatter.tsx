...
interface Props {
    ...
    onFieldChange: (
        ...
        field: keyof CalculationUnsapMatter,
        value: any
    ) => void;
...
const CalculationDetailUnsapMatter:
    React.FC<Props> = ({
        ...
        const fattyAcidInExtract =
            ...
            factor;
        // ========================================================
        // UNSAPONIFIABLE MATTER CALCULATION
        // ========================================================
        ...
        /*
            ...
            Unsaponifiable Matter (%) =
                ((Residue Weight - Fatty Acid in Extract)
                ÷ Sample Weight) × 100) × 100
        */

        const calculatedUnsapMatter =
            useMemo(() => {
        ...
        const validationErrors =
            useMemo(() => {
                ...
                if (emptyFlaskWeight < 0) {

                    errors.push(
                        "Weight of Empty Flask cannot be negative"
                    );

                }


                if (residueAndEmptyFlaskWeight < 0) {

                    errors.push(
                        "Weight of Residue + Empty Flask cannot be negative"
                    );
                ...
                if (
                    ...
                    errors.push(
                        "Weight of Residue + Empty Flask must be greater than or equal to Empty Flask Weight"
                    );
                ...
                if (titreValue < 0) {
                    ...
                    errors.push(
                        "Titre Value cannot be negative"
                    );
...
export default CalculationDetailUnsapMatter;