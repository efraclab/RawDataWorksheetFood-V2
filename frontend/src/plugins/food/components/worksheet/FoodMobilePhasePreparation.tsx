import MobilePhasePreparationDetail from "./MobilePhasePreparationDetail";
import React from "react";
import { AnimatePresence, motion } from "framer-motion";
import { Target } from "lucide-react";

import type { MobilePhasePreparation as MobilePhasePreparationModel } from "../../models/MobilePhasePreparation";
...
interface Props {
    ...
    mobilePhases: MobilePhasePreparationModel[];
...
const FoodMobilePhasePreparation: React.FC<Props> = ({
    isLocked,
                            ...
                            {mobilePhases.length === 0 ? (
                                ...
                                >
                                    ...
                                    <p className="text-emerald-600 mt-2">
                                        Click "Add Mobile Phase" to begin
                                    </p>
...
export default FoodMobilePhasePreparation;