...
> = ({ buffer, onStepChange, onRemove, isLocked }) => {
          ...
          <div className="relative flex items-center justify-between px-4 py-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="p-2 bg-white/20 rounded-lg transition-all duration-200 border border-white/30 disabled:opacity-50 disabled:cursor-not-allowed"
