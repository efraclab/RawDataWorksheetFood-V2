...
import type { MobilePhasePreparation } from "../../models/MobilePhasePreparation";
...
> = ({ mobilePhasePreparation, onEdit, onRemove, isLocked }) => {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -20 }}
      className="disabled:opacity-50 disabled:cursor-not-allowed mb-4 bg-white/80 backdrop-blur-sm border-2 border-emerald-300/50 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 overflow-hidden"
    >
      {/* Header */}
      <div className="disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-emerald-700 via-emerald-800 to-slate-900 px-4 py-3 border-b border-slate-700/40 flex items-center justify-between">
